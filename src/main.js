                            ...
                            if (!player.bankdoor_opened) {
                                ...
                                bankdoor.onAnimEnd((anim) => {
                                    if (anim === "open") {
                                        ...
                                        chargeTextureAt("ground",16,9,33)
                                        chargeTextureAt("ground",17,9,32)
                                        chargeTextureAt("ground",18,9,33)
                                        chargeTextureAt("ground",19,9,32)

                                        chargeTextureAt("ground",16,8,32)
                                        chargeTextureAt("ground",17,8,33)
                                        chargeTextureAt("ground",18,8,32)
                                        chargeTextureAt("ground",19,8,33)

                                        chargeTextureAt("ground",16,7,33)
                                        chargeTextureAt("ground",17,7,32)
                                        chargeTextureAt("ground",18,7,33)
                                        chargeTextureAt("ground",19,7,32)

                                        chargeTextureAt("ground",16,6,32)
                                        chargeTextureAt("ground",17,6,33)
                                        chargeTextureAt("ground",18,6,32)
                                        chargeTextureAt("ground",19,6,33)

                                        chargeTextureAt("ground",15,5,32)
